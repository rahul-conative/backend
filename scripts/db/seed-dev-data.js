  ...
  const cmsPages = [
    ...
    },
    {
      ...
      body: [
        ...
        "Create a seller account, complete profile and KYC details, then wait for marketplace review.",
      ].join("\n"),
      metadata: {
        footerGroup: "help",
        seoTitle: "FAQs",
        seoDescription: "Common questions about orders, returns, sellers, and accounts.",
        categories: ["orders", "returns", "seller", "account"],
      },
    },
    {
      ...
      metadata: {
        footerGroup: "help",
        seoTitle: "Help and Support",
        seoDescription: "Support information for customers and sellers.",
        contactCta: "/support",
      },
    },
    {
    ...
    {
      slug: "festival-sale-promotion-banner",
      title: "Festival Sale Promotion Banner",
      pageType: "promotion_banner",
      body: "Promotional banner for seasonal sale campaigns.",
      metadata: {
        placement: "promotion.hero",
        headline: "Festival sale is live",
        subtitle: "Limited-time deals across top categories.",
        imageUrl: "/assets/banners/festival-sale.jpg",
        mobileImageUrl: "/assets/banners/festival-sale-mobile.jpg",
        ctaLabel: "View Deals",
        ctaUrl: "/deals",
      ...
      metadata: {
        groups: [
          ...
          },
          {
            title: "Help",
            links: [
              { label: "FAQs", url: "/cms/faq" },
              { label: "Help and Support", url: "/cms/help-and-support" },
